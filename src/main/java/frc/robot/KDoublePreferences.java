...
public class KDoublePreferences {
    public static class PElevator {
        ...
        public static KDoublePref derivative = new KDoublePref("elevator derivative", 0.0); // should be tweaked

        public static KDoublePref speedlimit = new KDoublePref("elevator speed limit", 0.01);
        public static KDoublePref accelerationLimit =new KDoublePref("elevator acceleration limit", 0.01);
  }
    ...
    public static class PDrivetrain {
        ...
        public static final KDoublePref kPRotation = new KDoublePref( "rotation proportional", 0.06); // .02 is our autoturntofacetarget value; change this to like 0.10 in the case
        // that we do not get a kD value locked in
        public static final KDoublePref kIRotation = new KDoublePref("integral rotation", 0.000625); // .04 is our autoturntofacetarget value; change this to 0 in the case that
        // we do not get a kD value locked in
        public static final KDoublePref kDRotation = new KDoublePref("derivative rotation", 0.0); // 0.015 // this isn't done. this value must be tweaked more; if this is not
    ...
    // should switch this all to a set value when we finish tuning
        ...
        public static KDoublePref derivative = new KDoublePref("wrist derivative", 0.0); // should be tweaked
